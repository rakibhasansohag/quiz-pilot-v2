        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredQuestions.map(q => (
              <div
                key={q._id}
                className="group relative flex flex-col justify-between rounded-xl border border-gray-100 dark:border-gray-950 p-6 bg-gray-50 dark:bg-zinc-800 shadow-sm hover:shadow-sm transition-all duration-300 ease-in-out transform hover:-translate-y-1.5"
              >
                {/* Question Header */}
                <div>
